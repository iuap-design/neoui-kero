            ...
            if (!this.slice) {
                ...
                this.dynamic ? this.datasource && (this.trueValue = value, this.element.querySelectorAll(".u-radio").forEach(function(ele) {
                    ...
                    if (comp) {
                        ...
                        inptuValue && inptuValue == value ? (fetch = !0, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_dom__.f)(comp.element, "is-checked"), 
                        comp._btnElement.click()) : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_dom__.d)(comp.element, "is-checked");
                    }

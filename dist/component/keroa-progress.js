...
!function(modules) {
    ...
    "use strict";
    var __WEBPACK_IMPORTED_MODULE_0_tinper_sparrow_src_dom__ = __webpack_require__(2), __WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_env__ = __webpack_require__(4);
    ...
    var Progress = u.BaseComponent.extend({
        ...
        setProgress: function(p) {
            if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_tinper_sparrow_src_dom__.a)(this.element, this._CssClasses.INDETERMINATE_CLASS)) return this.progressbar_.style.width = p + "%", 
            this;
        },
        setProgressHeight: function(p) {
            if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_tinper_sparrow_src_dom__.a)(this.element, this._CssClasses.INDETERMINATE_CLASS)) return this.progressbar_.style.height = p + "%", 
            this.progressbar_.style.width = "100%", this;
        },
        setProgressHTML: function(html) {
            if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_tinper_sparrow_src_dom__.a)(this.element, this._CssClasses.INDETERMINATE_CLASS)) return this.progressbar_.innerHTML = html, 
            this;
        },
        ...
        init: function() {
            ...
            this.bufferbar_.style.width = "100%", this.auxbar_.style.width = "0%", __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_tinper_sparrow_src_dom__.b)(this.element, "is-upgraded"), 
            (__WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_env__.a.isIE8 || __WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_env__.a.isIE9) && __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_tinper_sparrow_src_dom__.a)(this.element, this._CssClasses.INDETERMINATE_CLASS)) {
                var p = 0, oThis = this;
    ...
    var __WEBPACK_IMPORTED_MODULE_0_tinper_neoui_src_neoui_progress__ = __webpack_require__(1);

...
var off$1 = function(element, eventName, listener) {
	//删除事件数组
	if(listener) {
...
var trigger$1 = function(element, eventName) {
...
(function() {
	...
	if((navigator.platform == "X11") && !u$2.isWin && !u$2.isMac) {
		u$2.isUnix = true;
	}
	...
	u$2.version = version ? (browserMatch.version ? browserMatch.version : 0) : 0;
	if(u$2.isAndroid){
		if(window.screen.width>=768&&window.screen.width<1024){
			u$2.isAndroidPAD=true;
		}
		if(window.screen.width<=768) {
			u$2.isAndroidPhone = true;
		}
	}
	if(u$2.isIE) {
		var intVersion = parseInt(u$2.version);
		var mode = document.documentMode;
		if(mode == null) {
			if(intVersion == 6 || intVersion == 7) {
				u$2.isIE8_BEFORE = true;
			}
		} else {
			if(mode == 7) {
				u$2.isIE8_BEFORE = true;
	...
	if(u$2.isIphone || u$2.isAndroidPhone)
		u$2.isMobile = true;
...
var URipple = function URipple(element) {
  ...
  URipple.prototype.init = function() {
    ...
    if (this._element) {
      ...
      this._ignoringMouseDown = false;
      on$1(this._element, 'mousedown',function(e){self._down(e);});
      on$1(this._element, 'touchstart',function(e){self._down(e);});

      on$1(this._element, 'mouseup',function(e){self._up(e);});
      on$1(this._element, 'mouseleave',function(e){self._up(e);});
      on$1(this._element, 'touchend',function(e){self._up(e);});
      on$1(this._element, 'blur',function(e){self._up(e);});
    }
  };

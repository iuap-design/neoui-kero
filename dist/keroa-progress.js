...
!function(modules) {
    ...
    var __WEBPACK_IMPORTED_MODULE_0_tinper_sparrow_src_dom__ = __webpack_require__(2), __WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_util__ = __webpack_require__(4);
    __webpack_require__.d(__webpack_exports__, "a", function() {
        return compMgr;
    });
    ...
    var inArray = ("function" == typeof Symbol && Symbol.iterator, Array.isArray, function(node, arr) {
    ...
    var Progress = __WEBPACK_IMPORTED_MODULE_0__neoui_BaseComponent__.a.extend({
        ...
        setProgress: function(p) {
            if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_dom__.a)(this.element, this._CssClasses.INDETERMINATE_CLASS)) return this.progressbar_.style.width = p + "%", 
            this;
        },
        setProgressHeight: function(p) {
            if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_dom__.a)(this.element, this._CssClasses.INDETERMINATE_CLASS)) return this.progressbar_.style.height = p + "%", 
            this.progressbar_.style.width = "100%", this;
        },
        setProgressHTML: function(html) {
            if (!__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_dom__.a)(this.element, this._CssClasses.INDETERMINATE_CLASS)) return this.progressbar_.innerHTML = html, 
            this;
        },
        ...
        init: function() {
            ...
            this.bufferbar_.style.width = "100%", this.auxbar_.style.width = "0%", __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_dom__.b)(this.element, "is-upgraded"), 
            (__WEBPACK_IMPORTED_MODULE_2_tinper_sparrow_src_env__.a.isIE8 || __WEBPACK_IMPORTED_MODULE_2_tinper_sparrow_src_env__.a.isIE9) && __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_dom__.a)(this.element, this._CssClasses.INDETERMINATE_CLASS)) {
                var p = 0, oThis = this;
    ...
    "use strict";
    var __WEBPACK_IMPORTED_MODULE_0_tinper_sparrow_src_class__ = __webpack_require__(7), __WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_util__ = __webpack_require__(4), __WEBPACK_IMPORTED_MODULE_2_tinper_sparrow_src_event__ = __webpack_require__(0), __WEBPACK_IMPORTED_MODULE_3_compox_src_compMgr__ = __webpack_require__(1);
    __webpack_require__.d(__webpack_exports__, "a", function() {
        return BaseComponent;
    });
    var BaseComponent = __WEBPACK_IMPORTED_MODULE_0_tinper_sparrow_src_class__.a.create({
        initialize: function(element) {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_tinper_sparrow_src_util__.b)(element) ? (this.element = element, 
    ...
    var __WEBPACK_IMPORTED_MODULE_0_tinper_neoui_src_neoui_progress__ = __webpack_require__(5);
    __webpack_require__.d(__webpack_exports__, "ProgressAdapter", function() {

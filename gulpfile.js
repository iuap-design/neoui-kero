...
gulp.task('libui', function() {
	return gulp.src(['./dist/js/u.js','./node_modules/tinper-neoui/vendor/ui/*.js'])
		.pipe(concat('u.js'))
...
gulp.task('dist', ['libui'], function(){
	gulp.src(['./node_modules/tinper-neoui/dist/css/**','./node_modules/neoui-grid/dist/css/**','./node_modules/neoui-tree/dist/css/**'])

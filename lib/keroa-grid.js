...
import { NumberMasker, PercentMasker, CurrencyMasker } from 'tinper-sparrow/src/util/masker';
import { dateRender, dateTimeRender } from 'tinper-sparrow/src/util/dataRender';
import { DataTable } from 'kero/src/indexDataTable';
import { stopEvent } from 'tinper-sparrow/src/event';
...
import { Validate } from 'tinper-neoui/src/neoui-validate';
import { showMessage } from 'tinper-neoui/src/neoui-message';
...
var GridAdapter = u.BaseAdapter.extend({
        ...
        $("div", this.$element).each(function () {
            ...
            if (rType == 'booleanRender') {
                ...
                column.renderType = function (obj) {
                    ...
                    disableStr = ' disabled';
                    var htmlStr = '<label class="u-switch">' + ' <input type="checkbox"  class="u-switch-input" ' + checkStr + disableStr + '>' + ' <span class="u-switch-label"></span>' + '</label>';
    ...
    createDefaultRender: function createDefaultRender(obj) {
        ...
        if (eOptions) {
            //判断是否为json对象
            if ((typeof eOptions === 'undefined' ? 'undefined' : babelHelpers['typeof'](eOptions)) == "object" && Object.prototype.toString.call(eOptions).toLowerCase() == "[object object]" && !obj.length) {
                eOptions = eOptions;
                //判断是否为string

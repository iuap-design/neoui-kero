...
!function(modules) {
    ...
    !function(global, factory) {
        ...
        var re_hideEditMenu = function() {
            ...
            if ("function" == typeof this.options.onBeforeEditFun) {
                ...
                obj.colIndex = colIndex, obj.$tr = $tr, !this.options.onBeforeEditFun(obj)) return void (-1 != this.eidtRowIndex && this.editClose());
            }
            -1 != this.eidtRowIndex && this.editClose();
            ...
            -1 != this.eidtRowIndex && this.editClose(), this.eidtRowIndex = i, this.editColIndex = 0, 
            this.editRow();
            ...
            $("#" + this.options.id + "_edit_field_" + field).length > 0 && ("checkbox" == $("#" + this.options.id + "_edit_field_" + field)[0].type ? $("#" + this.options.id + "_edit_field_" + field)[0].checked = "Y" == value || "true" == value || !0 === value : $("#" + this.options.id + "_edit_field_" + field)[0].value = value));
    ...
    !function(global, factory) {
        ...
        var renderTypeFun = function(obj) {
            ...
            gridCompColumn.options.field), end = begin, idSuffix = !0 === isFixedColumn ? "_content_fixed_tbody" : "_content_tbody", visibleColIndex = this.getVisibleIndexOfColumn(gridCompColumn);
            ...
            $.each(oThis.dataSourceObj.rows, function(j) {
                if (begin >= 0 && j >= begin && j <= end || isNaN(begin)) {
                    ...
                    var trIndex = j;
                    -1 != notRowIndex && j >= notRowIndex && trIndex++;
                    var tr = oThis.realtimeTableRows[trIndex], td = tr.children[i];
                    if (oThis.iconSpan) var iconSpan = oThis.iconSpan;
                    if (td) {
                        if (-1 != td.children[0].innerHTML.indexOf("u-grid-content-tree-span")) var span = td.children[0].children[1]; else var span = td.children[0];
                        if (span) {
                            var v = $(this.value).attr(field);
        ...
        var re_createContentRowsSumRow = function(createFlag) {
            ...
            if (this.options.showSumRow) {
                ...
                return $.each(gridCompColumnArr, function() {
                    ...
                    if ("float" == dataType) {
                        var o = {};
                        o.value = sumValue, o.precision = precision || 2, sumValue = oThis.DicimalFormater(o);
                    }
                    var tdStyle = "";
                    this.options.visible ? oThis.options.rowHeight && (tdStyle += 'style="height:' + oThis.options.rowHeight + "px;line-height:" + oThis.options.rowHeight + 'px;"') : (tdStyle = 'style="display:none;', 
                    oThis.options.rowHeight && (tdStyle += "height:" + oThis.options.rowHeight + "px;line-height:" + oThis.options.rowHeight + "px;"), 
            ...
            var oThis = this, sumCol = gridCompColumn.options.sumCol, sumRenderType = gridCompColumn.options.sumRenderType, dataType = gridCompColumn.options.dataType, idStr = !0 === isFixedColumn ? "fixed_" : "";
            if (sumCol) {
    ...
    !function(global, factory) {
        ...
        var swap_initEventFun = function() {
            ...
            $("#" + this.options.id).on("mousedown", function(e) {
                if ($(e.target).closest("#" + oThis.options.id + "_header").length > 0) {
                    var eleTh = $(e.target).closest("th")[0];
                    oThis.options.canSwap && eleTh && oThis.swapColumnStart(e, eleTh), e.preventDefault();
                } else $(e.target).closest("#" + oThis.options.id + "_content").length;
            }), $("#" + this.options.id).on("mousemove", function(e) {
    ...
    !function(global, factory) {
        ...
        var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(obj) {
            ...
            for (var value = obj.value + "", precision = obj.precision, i = 0; i < value.length; i++) if (-1 == "-0123456789.".indexOf(value.charAt(i))) return "";
